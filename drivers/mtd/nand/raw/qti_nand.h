...
#define QTI_NAND_CTRL			NAND_REG(0x0F00)
#define QTI_NAND_DEBUG			NAND_REG(0x0F0C)
...
#define QTI_HARDWARE_VERSION_2_0	0x20000000
#define NAND_FLASH_STATUS_MASK		0xC
#define QTI_SERIAL_ERROR		517
#define QTI_SPI_SET_FEATURE		(1 << 31)
#define QTI_SPI_GET_FEATURE		~(1 << 31)
#define QTI_SPI_WP_SET			(1 << 28)
#define QTI_SPI_HOLD_SET		(1 << 27)
#define QTI_SPI_TRANSFER_MODE_X1	(1 << 29)
#define QTI_SPI_TRANSFER_MODE_X4	(3 << 29)
#define QTI_SPI_BOOST_MODE		(1 << 11)
#define QTI_SPI_NAND_CTRL_VAL		0x341
#define QTI_PAGE_SCOPE_CMD_EN		(1 << 23)
#define QTI_MULTIPAGE_CMD_EN		(1 << 22)
#define QTI_LAST_PAGE_MASK		(1 << 5)
/* For all status
 * #define QTI_SPI_NAND_AUTO_STATUS_VAL 0x003F003F
 */
#define QTI_SPI_NAND_AUTO_STATUS_VAL	0x000B000B
#define QTI_SPI_MAX_CODE_WORD_2K_PAGE	0x4
#define QTI_SPI_MAX_STATUS_REG		12
#define QTI_AUTO_STATUS_BUFFER_SIZE	(QTI_SPI_MAX_CODE_WORD_2K_PAGE * \
					 QTI_SPI_MAX_STATUS_REG)
#define QTI_NAND_FLASH_CMD_WE_VAL	0XB800000F
#define QTI_NAND_FLASH_CMD_WD_VAL	0x3800000F
#define WR_EN				0x1
#define WR_DIS				0x0
...
#define QTI_AUTO_STATUS_DES_SIZE		12
...
/* NANDc EE */
#define QTI_NAND_EE				0

/* NANDc max desc length. */
#define QTI_NAND_MAX_DESC_LEN			0x7FFF
...
#define MTD_NAND_CHIP(mtd)			((struct nand_chip *) \
							((mtd)->priv))
#define MTD_QTI_NAND_DEV(mtd)			(MTD_NAND_CHIP(mtd)->priv)
...
#define QTI_NUM_XFER_STEPS				7
#define FB_CLK_BIT                              (1 << 4)

#ifdef QSPI_SERIAL_DEBUG
...
struct qti_nand_init_config
{
	...
	struct qti_nand_bam_pipes pipes;
};
...
struct qcom_nand_controller {
	...
	struct qti_serial_nand_params *serial_params;
	uint32_t flash_sts[QTI_NAND_MAX_CWS_IN_PAGE];
	uint32_t buffer_sts[QTI_NAND_MAX_CWS_IN_PAGE];
	uint32_t *nandc_buffer;
	struct bam_desc *qti_cmd_desc_fifo;
