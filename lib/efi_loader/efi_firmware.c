 ...
 *
 * @fw_version:			Current firmware version
 * @lowest_supported_version:	Lowest supported version (not stored in EFI var for security)
 * @last_attempt_version:	Version of last attempted update
 * @last_attempt_status:	Status of last attempted update
 */
struct fmp_state {
	u32 fw_version;
