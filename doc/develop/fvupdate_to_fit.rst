...
.. list-table::
   ...
   * - ``xml_file``
     ...
     - Required
   * - ``--guid``
     - GUID value of the board (enables complete mode). Board-specific GUIDs: Talos: ``9FD379D2-670E-4BB3-86A1-40497E6E17B0``, Kodiak: ``6f25bfd2-a165-468b-980f-ac51a0a45c52``
     - Required
   * - ``--mkeficapsule``
...
- **Talos**: ``9FD379D2-670E-4BB3-86A1-40497E6E17B0``
- **Kodiak**: ``6f25bfd2-a165-468b-980f-ac51a0a45c52``

Example valid GUID: ``12345678-1234-5678-9abc-123456789abc``
