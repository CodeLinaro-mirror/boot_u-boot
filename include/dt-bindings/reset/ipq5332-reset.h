...
#define NSS_CC_UNIPHY_PORT1_RX_RESET			8
#define NSS_CC_UNIPHY_PORT1_TX_RESET			9
#define NSS_CC_UNIPHY_PORT2_RX_RESET			10
#define NSS_CC_UNIPHY_PORT2_TX_RESET			11
